        ...
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
          ...
          <div class="mb-10 md:mb-16">
            ...
            <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
              Get mentored by Directors, VPs and Heads of top companies and
              heavyweights of the advertising industry.
            </p>
          </div>
          {/* <!-- text - end --> */}
          ...
          <Slider {...settings}>
            {/* <!-- person - start --> */}
            <div class="flex flex-col items-center   w90 rounded-lg bg-gray-100  p-4 lg:p-8">
